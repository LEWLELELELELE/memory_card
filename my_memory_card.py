...
lbl_question = QLabel('Какой национальности не муществует?')
...
question_list = []
question_list.append(Question('Государственый язык Бразилии', 'Португальский', 'Бразильский', 'Испанский', 'Итальянский'))
question_list.append(Question('Какая самая большая страна в мире', 'Россия', 'Америка', 'Китай', 'Канада'))
question_list.append(Question('Какая самая населённая страна в мире', 'Китай', 'Беларусь', 'Америка', 'Россия'))
question_list.append(Question('Какой игры не существует', 'Дота 5', 'Фортнайт', 'Дота 2', 'Роблокс'))
